...
public class CustomerItemOrder {
    public static void main(String[] args) {
        ...
        try
        {
            ...
            System.out.print("Enter customer number number or " +QUIT + " to quit: ");
            cString = sc.nextLine();
            while(!cString.equals(QUIT))
            {
                ...
                else
                {
                    ...
                    {
                        System.out.print("Customer: " + arrayC[0] +"   Name: " + arrayC[1] + "   zip code: " + arrayC[2]);
                        System.out.println("  ordered Item #" + arrayI[0] +" which is a " + arrayI[1]);
                    }
                }
